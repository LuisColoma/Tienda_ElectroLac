...
from ElectroLac.settings import BASE_DIR
...
def create_dataset(request):   
    ...
    while(True):
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.imwrite('/Users/lcolo/Desktop/PFINAL_Django/ElectroLac1/ElectroLac/ml/dataset/' +'usuario'+'.'+str(id)+'.'+str(sampleNum)+'.jpg', gray[y:y+h,x:x+w])
...
def trainer(request):
    ...
    #Path of the samples
    path = '/Users/lcolo/Desktop/PFINAL_Django/ElectroLac1/ElectroLac/ml/dataset/'
    ...
    recognizer.save('/Users/lcolo/Desktop/PFINAL_Django/ElectroLac1/ElectroLac/ml/recognizer/trainingData.yml')
    cv2.destroyAllWindows()
    return redirect('/')
...
def detect(request):
    ...
    rec.read('/Users/lcolo/Desktop/PFINAL_Django/ElectroLac1/ElectroLac/ml/recognizer/trainingData.yml')
    getId = 0
    ...
    while(True):
        ...
        if(cv2.waitKey(1) == ord('q')):
            ...
            cam.release()
            cv2.destroyAllWindows()
            return redirect('perfil/'+str(userId))
